...
<head>
    ...
    <style>
        /* CSS para que el footer quede fijo abajo si hay pocos elementos */
        body {
            display: flex;
...
<body>
    ...
    <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
        <div class="col-md-4 d-flex align-items-center">
            ...
            <span class="mb-3 mb-md-0 text-muted">&copy; <?= date("Y"); ?> Sistema de notas Academicas para Instituciones </span>
        </div>
